# Auto generated from tomography.yaml by pythongen.py version: 0.0.1
# Generation date: 2025-12-05T11:41:59
# Schema: TomographyAdditionalFields
#
# id: https://w3id.org/oscem-schemas/latest/tomography
...
DEFAULT_ = CurieNamespace('', 'https://w3id.org/oscem-schemas/latest/tomography/')
...
class Range(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/oscem-schemas/latest/tomography/Range")
...
class Series(Range):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/oscem-schemas/latest/tomography/Series")
...
class TiltAngle(Series):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/oscem-schemas/latest/tomography/TiltAngle")
...
class ImageSize(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/oscem-schemas/latest/tomography/ImageSize")
...
class BoundingBox2D(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/oscem-schemas/latest/tomography/BoundingBox2D")
...
class QuantityValue(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/oscem-schemas/latest/tomography/QuantityValue")
...
class QuantitySI(QuantityValue):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/oscem-schemas/latest/tomography/QuantitySI")
...
class Descriptor(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/oscem-schemas/latest/tomography/Descriptor")
...
class Descriptors(Descriptor):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/oscem-schemas/latest/tomography/Descriptors")
...
class Acquisition(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/oscem-schemas/latest/tomography/Acquisition")
...
class AcquisitionTomo(Acquisition):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/oscem-schemas/latest/tomography/AcquisitionTomo")
...
class AcquisitionSubTomo(AcquisitionTomo):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/oscem-schemas/latest/tomography/AcquisitionSubTomo")
...
class AcquisitionEnvTomo(AcquisitionTomo):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/oscem-schemas/latest/tomography/AcquisitionEnvTomo")
...
class AcquisitionCelTomo(AcquisitionTomo):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/oscem-schemas/latest/tomography/AcquisitionCelTomo")
...
class AcquisitionSpa(Acquisition):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/oscem-schemas/latest/tomography/AcquisitionSpa")
...
class EnergyFilter(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/oscem-schemas/latest/tomography/EnergyFilter")
...
class SpecialistOptics(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/oscem-schemas/latest/tomography/SpecialistOptics")
...
class Phaseplate(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/oscem-schemas/latest/tomography/Phaseplate")
...
class SphericalAberrationCorrector(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/oscem-schemas/latest/tomography/SphericalAberrationCorrector")
...
class ChromaticAberrationCorrector(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/oscem-schemas/latest/tomography/ChromaticAberrationCorrector")
...
class Detector(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/oscem-schemas/latest/tomography/Detector")
...
slots.tilt_axis_angle = Slot(uri=DEFAULT_.tilt_axis_angle, name="tilt_axis_angle", curie=DEFAULT_.curie('tilt_axis_angle'),
                   model_uri=DEFAULT_.tilt_axis_angle, domain=None, range=Optional[float])

slots.tilt_angle = Slot(uri=DEFAULT_.tilt_angle, name="tilt_angle", curie=DEFAULT_.curie('tilt_angle'),
...
slots.AcquisitionTomo_tilt_axis_angle = Slot(uri=DEFAULT_.tilt_axis_angle, name="AcquisitionTomo_tilt_axis_angle", curie=DEFAULT_.curie('tilt_axis_angle'),
                   model_uri=DEFAULT_.AcquisitionTomo_tilt_axis_angle, domain=AcquisitionTomo, range=float)

slots.AcquisitionTomo_tilt_angle = Slot(uri=DEFAULT_.tilt_angle, name="AcquisitionTomo_tilt_angle", curie=DEFAULT_.curie('tilt_angle'),
