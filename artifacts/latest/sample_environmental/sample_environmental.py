...
# Generation date: 2025-12-05T01:27:52
...
class SampleEnv(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SAMPLE_ENV.SampleEnv
...
class SpecimenEnv(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SAMPLE_ENV.SpecimenEnv
...
class Freezing(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SAMPLE_ENV.Freezing
...
class Thinning(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SAMPLE_ENV.Thinning
...
class TomogramFeatures(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SAMPLE_ENV.TomogramFeatures
...
class Range(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SAMPLE_ENV.Range
...
class Series(Range):
    ...
    class_model_uri: ClassVar[URIRef] = SAMPLE_ENV.Series
...
class ImageSize(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SAMPLE_ENV.ImageSize
...
class BoundingBox2D(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SAMPLE_ENV.BoundingBox2D
...
class QuantityValue(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SAMPLE_ENV.QuantityValue
...
class QuantitySI(QuantityValue):
    ...
    class_model_uri: ClassVar[URIRef] = SAMPLE_ENV.QuantitySI
...
class Descriptor(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SAMPLE_ENV.Descriptor
...
class Descriptors(Descriptor):
    ...
    class_model_uri: ClassVar[URIRef] = SAMPLE_ENV.Descriptors
...
slots.target_thickness = Slot(uri=SAMPLE_ENV.target_thickness, name="target_thickness", curie=SAMPLE_ENV.curie('target_thickness'),
                   model_uri=SAMPLE_ENV.target_thickness, domain=None, range=Optional[Union[dict, QuantitySI]])

slots.lift_out = Slot(uri=SAMPLE_ENV.lift_out, name="lift_out", curie=SAMPLE_ENV.curie('lift_out'),
                   model_uri=SAMPLE_ENV.lift_out, domain=None, range=Optional[Union[bool, Bool]])
...
slots.tomogram_features = Slot(uri=SAMPLE_ENV.tomogram_features, name="tomogram_features", curie=SAMPLE_ENV.curie('tomogram_features'),
                   model_uri=SAMPLE_ENV.tomogram_features, domain=None, range=Optional[Union[dict, TomogramFeatures]])
...
slots.descriptor_name = Slot(uri=CUSTOM_TYPES.descriptor_name, name="descriptor_name", curie=CUSTOM_TYPES.curie('descriptor_name'),
                   model_uri=SAMPLE_ENV.descriptor_name, domain=None, range=Optional[str])
...
slots.descriptor_thing = Slot(uri=CUSTOM_TYPES.descriptor_thing, name="descriptor_thing", curie=CUSTOM_TYPES.curie('descriptor_thing'),
                   model_uri=SAMPLE_ENV.descriptor_thing, domain=None, range=Optional[Union[dict, Any]])

slots.valueSI = Slot(uri=CUSTOM_TYPES.valueSI, name="valueSI", curie=CUSTOM_TYPES.curie('valueSI'),
                   model_uri=SAMPLE_ENV.valueSI, domain=None, range=Optional[float])

slots.unitSI = Slot(uri=CUSTOM_TYPES.unitSI, name="unitSI", curie=CUSTOM_TYPES.curie('unitSI'),
                   model_uri=SAMPLE_ENV.unitSI, domain=None, range=Optional[str])
...
slots.Descriptor_descriptor_name = Slot(uri=CUSTOM_TYPES.descriptor_name, name="Descriptor_descriptor_name", curie=CUSTOM_TYPES.curie('descriptor_name'),
                   model_uri=SAMPLE_ENV.Descriptor_descriptor_name, domain=Descriptor, range=str)
...
slots.Descriptor_descriptor_thing = Slot(uri=CUSTOM_TYPES.descriptor_thing, name="Descriptor_descriptor_thing", curie=CUSTOM_TYPES.curie('descriptor_thing'),
                   model_uri=SAMPLE_ENV.Descriptor_descriptor_thing, domain=Descriptor, range=Optional[Union[dict, Any]])
