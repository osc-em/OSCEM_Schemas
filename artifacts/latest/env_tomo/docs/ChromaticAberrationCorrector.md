...
URI: [https://w3id.org/oscem-schemas/latest/env_tomo/ChromaticAberrationCorrector](https://w3id.org/oscem-schemas/latest/env_tomo/ChromaticAberrationCorrector)
