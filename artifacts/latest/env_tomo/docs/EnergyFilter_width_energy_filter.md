...
URI: [https://w3id.org/oscem-schemas/latest/env_tomo/EnergyFilter_width_energy_filter](https://w3id.org/oscem-schemas/latest/env_tomo/EnergyFilter_width_energy_filter)
