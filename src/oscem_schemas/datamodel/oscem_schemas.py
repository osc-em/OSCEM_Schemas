...
# Generation date: 2025-02-17T15:04:11
...
class EMDataset(YAMLRoot):
    ...
    processing: Union[dict, "Processing"] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self._is_empty(self.processing):
            self.MissingRequiredField("processing")
...
class Processing(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/osc-em/oscem-schemas/Processing")
...
class Descriptor(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/osc-em/oscem-schemas/Descriptor")
...
class Descriptors(Descriptor):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/osc-em/oscem-schemas/Descriptors")
...
class Movies(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/osc-em/oscem-schemas/Movies")
...
class Micrographs(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/osc-em/oscem-schemas/Micrographs")
...
class CTFs(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/osc-em/oscem-schemas/CTFs")
...
class Defocus(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/osc-em/oscem-schemas/Defocus")
...
class Resolution(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/osc-em/oscem-schemas/Resolution")
...
class Astigmatism(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/osc-em/oscem-schemas/Astigmatism")
...
class Coordinates(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/osc-em/oscem-schemas/Coordinates")
...
class Classes2D(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/osc-em/oscem-schemas/Classes2D")
...
class Classes3D(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/osc-em/oscem-schemas/Classes3D")
...
class Volume(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/osc-em/oscem-schemas/Volume")
...
class OrthogonalSlices(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/osc-em/oscem-schemas/OrthogonalSlices")
...
class IsosurfaceImages(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/osc-em/oscem-schemas/IsosurfaceImages")
...
class Volumes(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/osc-em/oscem-schemas/Volumes")
...
slots.descriptors = Slot(uri=TYPES.descriptors, name="descriptors", curie=TYPES.curie('descriptors'),
                   model_uri=DEFAULT_.descriptors, domain=None, range=Optional[Union[Union[dict, Descriptors], List[Union[dict, Descriptors]]]])

slots.descriptor_name = Slot(uri=TYPES.descriptor_name, name="descriptor_name", curie=TYPES.curie('descriptor_name'),
                   model_uri=DEFAULT_.descriptor_name, domain=None, range=Optional[str])

slots.descriptor_thing = Slot(uri=TYPES.descriptor_thing, name="descriptor_thing", curie=TYPES.curie('descriptor_thing'),
...
slots.EMDataset_processing = Slot(uri=DEFAULT_.processing, name="EMDataset_processing", curie=DEFAULT_.curie('processing'),
                   model_uri=DEFAULT_.EMDataset_processing, domain=EMDataset, range=Union[dict, "Processing"])
...
slots.Descriptor_descriptor_name = Slot(uri=TYPES.descriptor_name, name="Descriptor_descriptor_name", curie=TYPES.curie('descriptor_name'),
                   model_uri=DEFAULT_.Descriptor_descriptor_name, domain=Descriptor, range=str)

slots.Descriptor_descriptor_thing = Slot(uri=TYPES.descriptor_thing, name="Descriptor_descriptor_thing", curie=TYPES.curie('descriptor_thing'),
...
slots.Movies_descriptors = Slot(uri=TYPES.descriptors, name="Movies_descriptors", curie=TYPES.curie('descriptors'),
...
slots.Micrographs_descriptors = Slot(uri=TYPES.descriptors, name="Micrographs_descriptors", curie=TYPES.curie('descriptors'),
...
slots.CTFs_descriptors = Slot(uri=TYPES.descriptors, name="CTFs_descriptors", curie=TYPES.curie('descriptors'),
...
slots.Coordinates_descriptors = Slot(uri=TYPES.descriptors, name="Coordinates_descriptors", curie=TYPES.curie('descriptors'),
...
slots.Classes2D_descriptors = Slot(uri=TYPES.descriptors, name="Classes2D_descriptors", curie=TYPES.curie('descriptors'),
...
slots.Classes3D_descriptors = Slot(uri=TYPES.descriptors, name="Classes3D_descriptors", curie=TYPES.curie('descriptors'),
...
slots.Volumes_descriptors = Slot(uri=TYPES.descriptors, name="Volumes_descriptors", curie=TYPES.curie('descriptors'),
