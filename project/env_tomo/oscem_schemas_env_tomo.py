...
# Generation date: 2025-11-17T17:51:45
...
class EMDatasetEnv(EMDatasetBase):
    ...
    class_class_uri: ClassVar[URIRef] = OSCEM["-env-tomo/EMDatasetEnv"]
    class_class_curie: ClassVar[str] = "oscem:-env-tomo/EMDatasetEnv"
