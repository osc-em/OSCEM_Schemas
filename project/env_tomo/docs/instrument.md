...
[![img](https://yuml.me/diagram/nofunky;dir:TB/class/[Any]<cs%201..1-++[Instrument&#124;microscope:string;illumination:string;imaging:string;electron_source:string],[Any]<c2_aperture%200..1-++[Instrument],[Any]<acceleration_voltage%201..1-++[Instrument],[EMDatasetEnv]++-%20instrument%201..1>[Instrument],[EMDatasetEnv],[Any])](https://yuml.me/diagram/nofunky;dir:TB/class/[Any]<cs%201..1-++[Instrument&#124;microscope:string;illumination:string;imaging:string;electron_source:string],[Any]<c2_aperture%200..1-++[Instrument],[Any]<acceleration_voltage%201..1-++[Instrument],[EMDatasetEnv]++-%20instrument%201..1>[Instrument],[EMDatasetEnv],[Any])
