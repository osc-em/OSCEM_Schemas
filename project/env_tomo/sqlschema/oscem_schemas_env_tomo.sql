...
-- # Class: "AcquisitionSpa" Description: ""
--     * Slot: id Description: 
...
--     * Slot: beamtilt_id Description: Another way to move the beam above the sample for data collection purposes that does not require movement of the stage. Given in mrad.
--     * Slot: imageshift_id Description: Movement of the Beam below the image in order to shift the image on the detector. Given in µm.
-- # Class: "AcquisitionSubTomo" Description: ""
--     * Slot: id Description: 
--     * Slot: tilt_axis_angle Description: The tilt axis angle of a tomography series
...
--     * Slot: beamtilt_id Description: Another way to move the beam above the sample for data collection purposes that does not require movement of the stage. Given in mrad.
--     * Slot: imageshift_id Description: Movement of the Beam below the image in order to shift the image on the detector. Given in µm.
-- # Class: "AcquisitionEnvTomo" Description: ""
--     * Slot: id Description: 
--     * Slot: tilt_axis_angle Description: The tilt axis angle of a tomography series
...
--     * Slot: beamtilt_id Description: Another way to move the beam above the sample for data collection purposes that does not require movement of the stage. Given in mrad.
--     * Slot: imageshift_id Description: Movement of the Beam below the image in order to shift the image on the detector. Given in µm.
-- # Class: "AcquisitionCelTomo" Description: ""
--     * Slot: id Description: 
--     * Slot: tilt_axis_angle Description: The tilt axis angle of a tomography series
...
-- # Class: "AcquisitionSpa_detectors" Description: ""
...
--     * Slot: detectors_id Description: 
-- # Class: "AcquisitionSubTomo_detectors" Description: ""
--     * Slot: AcquisitionSubTomo_id Description: Autocreated FK slot
--     * Slot: detectors_id Description: 
-- # Class: "AcquisitionEnvTomo_detectors" Description: ""
--     * Slot: AcquisitionEnvTomo_id Description: Autocreated FK slot
--     * Slot: detectors_id Description: 
-- # Class: "AcquisitionCelTomo_detectors" Description: ""
...
CREATE TABLE "EMDatasetEnv" (
	...
	organizational_id INTEGER, 
	PRIMARY KEY (id), 
	FOREIGN KEY(acquisition_id) REFERENCES "AcquisitionEnvTomo" (id), 
